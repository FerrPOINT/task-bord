...
export default abstract class AbstractService<Model extends IAbstract = IAbstract> {
	 ...
	 * Services can use this to implement functions to do post requests.
	 */
	...
	/**
	 * An abstract implementation to send put requests.
	 * Services can use this to implement functions to do put requests.
	 */
