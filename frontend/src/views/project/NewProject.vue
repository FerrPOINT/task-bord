<template>
	<CreateEdit
		...
		:primary-disabled="project.title === '' || project.identifier === ''"
	...
	>
		...
		<FormField
			...
			maxlength="10"
			:error="showError && project.identifier === '' ? $t('project.create.addIdentifierRequired') : null"
			@keyup.enter="createProject()"
		/>
		<FormField
...
async function createProject() {
	if (project.title === '' || project.identifier === '') {
