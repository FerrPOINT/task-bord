...
const taskListFilterDoc = "Filtering, sorting and search apply to every variant. See https://taskboard.io/docs/filters for the filter language."
...
type TaskListQueryParams struct {
	ListParams
	Filter             string   `query:"filter" doc:"Filter query to match tasks by. See https://taskboard.io/docs/filters."`
