...
type TaskCollection struct {
	...
	Filter string `query:"filter" json:"filter" doc:"The filter query to match tasks by. See https://taskboard.io/docs/filters."`
	...
	// If set to `subtasks`, taskboard will fetch only tasks which do not have subtasks and then in a
