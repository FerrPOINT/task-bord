...
import (
	...
	"github.com/FerrPOINT/task-bord/pkg/modules/avatar/empty"
	"github.com/FerrPOINT/task-bord/pkg/modules/avatar/initials"
	"github.com/FerrPOINT/task-bord/pkg/modules/avatar/upload"
...
// than an error, since avatars are loaded via <img> tags) and clamps the size to
