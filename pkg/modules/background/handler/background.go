...
import (
	...
	auth2 "github.com/FerrPOINT/task-bord/pkg/modules/auth"
	"github.com/FerrPOINT/task-bord/pkg/modules/background"
	"github.com/FerrPOINT/task-bord/pkg/modules/background/upload"
...
// read) and stats it for the modtime the download uses for caching. Returns
// ErrProjectHasNoBackground when the project has none; the caller owns committing
// the session and closing bgFile.File.
