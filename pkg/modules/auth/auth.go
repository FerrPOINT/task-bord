...
const RefreshTokenCookieName = "taskboard_refresh_token" //nolint:gosec // not a credential
...
// context.Context, bridging Huma handlers to taskboard's echo JWT flow. The
